    ...
    <div class="container">
        ...
        @if(empty($productsByCategory))
            <div class="text-center py-5">
                ...
                <h3>No Electrical Products Found</h3>
                <p class="text-muted">Products will appear here once added by admin.</p>
            </div>
        @else
            <!-- Products Grid by Category -->
            <div class="electrical-products-container">
                @foreach($productsByCategory as $categoryName => $products)
                                        ...
                                        <div class="product-image-container">
                                            @if($product->featured_image)
                                                <img src="{{ Storage::url($product->featured_image) }}"
                                                     ...
                                                     class="img-fluid">
                                            @else
                                                <img src="{{ asset('homepage/file/assets/logo/electrical-default.png') }}"
                                                     alt="Electrical Product"
                                                     class="img-fluid">
                                            @endif
                                        </div>
...
<style>
    ...
    /* Ensure modal appears above the blur backdrop */
    .modal {
    ...
    /* Electrical Products Page Styles */
    .product-item {
        display: block;
    }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Handle product details modal events
    ...
    document.querySelectorAll('.view-details').forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            const category = card.querySelector('.text-primary-custom')?.textContent || 'Electrical Product';
