    ...
    <div class="container">
        ...
        @if(empty($productsByCategory))
            <div class="text-center py-5">
                ...
                <h3>No Mechanical Products Found</h3>
                <p class="text-muted">Products will appear here once added by admin.</p>
            </div>
        @else
            <!-- Products Grid by Category -->
            <div class="mechanical-products-container">
                @foreach($productsByCategory as $categoryName => $products)
                                        ...
                                        <div class="product-image-container">
                                            @if($product->featured_image)
                                                <img src="{{ Storage::url($product->featured_image) }}"
                                                     ...
                                                     class="img-fluid">
                                            @else
                                                <img src="{{ asset('homepage/file/assets/logo/mechanical-default.png') }}"
                                                     alt="Mechanical Product"
                                                     class="img-fluid">
                                            @endif
                                        </div>
...
<style>
    ...
    /* Mechanical Products Page Styles */
    .product-item {
        display: block;
    }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.view-details').forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            const category = card.querySelector('.text-primary-custom')?.textContent || 'Mechanical Product';
