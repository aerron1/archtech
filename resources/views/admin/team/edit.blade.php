...
<head>
    ...
    <title>Edit Team Member - Archtech Admin</title>
    <!-- SweetAlert2 CSS -->
        ...
        <div class="admin-main" id="adminMain">
            ...
            <div class="admin-header">
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <div>
                        <h1 style="color: #084433; margin: 0 0 5px 0;">Edit Team Member</h1>
                        <p class="text-muted" style="margin: 0;">Update team member details</p>
                    </div>
                ...
                <form action="{{ route('admin.team.update', $team) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        @error('password')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                        <small class="text-muted">Minimum 8 characters. Include uppercase, lowercase, numbers, and symbols.</small>
                    </div>
